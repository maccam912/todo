...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_users_tokens_context_token", "users_tokens", ["context", "token"], unique=True
    )
    ...
    op.create_index(
        op.f("ix_user_access_tokens_user_id"), "user_access_tokens", ["user_id"], unique=False
    )
    op.create_index(
        "idx_user_access_tokens_hash", "user_access_tokens", ["token_hash"], unique=True
    )
    ...
    op.create_table(
        ...
        sa.UniqueConstraint(
            "group_id", "member_group_id", name="idx_group_memberships_group_group"
        ),
    )
    ...
    op.create_index(
        op.f("ix_group_memberships_member_group_id"),
        "group_memberships",
        ["member_group_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_tasks_assigned_group_id"), "tasks", ["assigned_group_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.PrimaryKeyConstraint("id"),
        sa.UniqueConstraint(
            "blocked_task_id", "prereq_task_id", name="idx_task_dependencies_unique"
        ),
    )
    op.create_index(op.f("ix_task_dependencies_id"), "task_dependencies", ["id"], unique=False)
    op.create_index(
        "idx_task_dependencies_blocked", "task_dependencies", ["blocked_task_id"], unique=False
    )
    op.create_index(
        "idx_task_dependencies_prereq", "task_dependencies", ["prereq_task_id"], unique=False
    )
